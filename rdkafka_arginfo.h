 ...
 * Stub hash: 6d4a581705626f0c7e7c7049a0bb29dd38a055d3 */
...
#if (PHP_VERSION_ID >= 80100)
ZEND_BEGIN_ARG_WITH_TENTATIVE_RETURN_OBJ_INFO_EX(arginfo_class_RdKafka_getMainQueue, 0, 0, RdKafka\\Queue, 0)
#else
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_RdKafka_getMainQueue, 0, 0, 0)
#endif
ZEND_END_ARG_INFO()
...
#define arginfo_class_RdKafka_Consumer_newQueue arginfo_class_RdKafka_getMainQueue
...
ZEND_METHOD(RdKafka, getMainQueue);
...
static const zend_function_entry class_RdKafka_methods[] = {
	...
	ZEND_ME(RdKafka, getMainQueue, arginfo_class_RdKafka_getMainQueue, ZEND_ACC_PUBLIC)
